...
function sortTableByColumn(table, column, headtext, asc = true) {
	...
	// Sort each row
	if (headtext == "Number of Shares" || headtext == "Total invested in $" || headtext == "Avg. Buy" || headtext == "Avg. Sell" || headtext == "Performance in $" || headtext == "Performance in %"){
...
document.querySelectorAll(".portfolio_table_sortable th").forEach(headerCell => {
